...
const FeatureCard = ({ icon: Icon, title, description, delay }) => (
  <motion.div
    ...
    className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 hover:border-amber-500/50 transition-all duration-300 shadow-xl hover:shadow-amber-500/20"
  >
    ...
    <h3 className="text-2xl font-bold mb-3 text-white font-cormorant">{title}</h3>
    <p className="text-slate-300 leading-relaxed font-inter">{description}</p>
  </motion.div>
);
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <h3 className="text-white text-xl font-bold font-cormorant">{image.title}</h3>
              </div>
            </div>
          </motion.div>
        ))}
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-light mb-8 text-white font-cormorant tracking-wide">
                Luxury Living <span className="italic font-normal">Redefined</span>
              </h2>
            </motion.div>
            ...
            >
              Experience the pinnacle of modern architecture and sophisticated design in the heart of Baghajatin
            </motion.p>
      ...
      <section className="py-32 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-bold mb-6 font-playfair">
              About <span className="bg-gradient-to-r from-amber-400 to-orange-600 text-transparent bg-clip-text">Sun Parivar</span>
            </h2>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm p-12 md:p-16 rounded-3xl border border-slate-700/50 shadow-2xl">
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed font-inter mb-6">
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm p-12 rounded-3xl border border-slate-700/50 shadow-2xl hover:border-amber-500/50 transition-all duration-300"
            >
              <div className="bg-gradient-to-br from-amber-500 to-orange-600 w-16 h-16 rounded-xl flex items-center justify-center mb-8 shadow-lg">
                <Building2 className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-4xl md:text-5xl font-bold mb-6 text-white font-playfair">
                Our <span className="bg-gradient-to-r from-amber-400 to-orange-600 text-transparent bg-clip-text">Mission</span>
              </h3>
              <p className="text-lg text-slate-300 leading-relaxed font-inter mb-4">
      ...
      <section className="py-32 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto font-inter font-light">
          ...
          >
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl shadow-amber-500/20 border border-amber-500/30">
              {!isVideoPlaying ? (
                <div className="relative w-full h-full group cursor-pointer" onClick={() => setIsVideoPlaying(true)}>
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative w-28 h-28 bg-gradient-to-br from-amber-400 to-orange-600 rounded-full flex items-center justify-center shadow-2xl">
                  ...
                  <div className="absolute bottom-8 left-8 right-8 text-white">
                    <h3 className="text-3xl font-bold mb-2 font-cormorant">Sun Ashraya Virtual Walkthrough</h3>
                    <p className="text-slate-200 font-inter">Click to experience luxury living</p>
                  </div>
                </div>
              ) : (
                <div className="w-full h-full bg-slate-900 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-slate-400 font-inter">Your video would load here</p>
                    <p className="text-slate-500 text-sm mt-2 font-inter">Replace with your video URL</p>
                  </div>
                </div>
              )}
            </div>
      ...
      <section className="py-32 px-4">
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-bold mb-6 font-playfair">
              Experience <span className="bg-gradient-to-r from-amber-400 to-orange-600 text-transparent bg-clip-text">Excellence</span>
            </h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto font-inter font-light">
          ...
          <ImageGallery
            images={[
              { src: Photo1, alt: "Luxury living room with city view" },
              { src: Photo2, alt: "Designer bathroom with marble and gold fixtures" },
              { src: Photo3, alt: "Modern parking facility" },
              { src: Photo4, alt: "Luxury living room with city view" },
              { src: Photo5, alt: "Designer bathroom with marble and gold fixtures" },
              { src: Photo6, alt: "Modern parking facility" },
              { src: Photo7, alt: "Luxury living room with city view" },
              { src: Photo8, alt: "Designer bathroom with marble and gold fixtures" },
              { src: Photo9, alt: "Modern parking facility" },
              { src: Photo10, alt: "Luxury living room with city view" },
              { src: Photo11, alt: "Designer bathroom with marble and gold fixtures" },
              { src: Photo12, alt: "Modern parking facility" },
              { src: Photo13, alt: "Luxury living room with city view" },
               { src: Photo14, alt: "Luxury living room with city view" },
                { src: Photo15, alt: "Luxury living room with city view" }
            ]}
          />
        </div>
      </section>
      ...
      <section className="py-32 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
            ...
            >
              <div className="p-8 bg-gradient-to-r from-amber-500/20 to-orange-600/20 border-b border-amber-500/30">
                <h3 className="text-3xl md:text-4xl font-bold text-white font-playfair mb-2">
                  Ground Floor Plan
                </h3>
                <p className="text-slate-300 font-inter">Spacious garden area and modern entrance</p>
              </div>
              <div className="p-8">
                <img 
                  src={GroundFloor} 
            ...
            >
              <div className="p-8 bg-gradient-to-r from-amber-500/20 to-orange-600/20 border-b border-amber-500/30">
                ...
                <p className="text-slate-300 font-inter">Elegant rooftop with premium amenities</p>
              </div>
              <div className="p-8">
                <img 
                  src={UpperFloor} 
      ...
      <section className="py-32 px-4 relative">
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-bold mb-6 font-playfair">
              Get in <span className="bg-gradient-to-r from-amber-400 to-orange-600 text-transparent bg-clip-text">Touch</span>
            </h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto font-inter font-light">
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm p-12 rounded-3xl border border-slate-700/50 shadow-2xl"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2 font-cormorant">Phone</h3>
                    <a href="tel:+919230997919" className="text-slate-300 hover:text-amber-400 transition-colors font-inter">
                      +91 92309 97919
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2 font-cormorant">Email</h3>
                    <a href="mailto:info@sunashraya.com" className="text-slate-300 hover:text-amber-400 transition-colors font-inter">
                      info@sunashraya.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 md:col-span-2">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2 font-cormorant">Location</h3>
                    <p className="text-slate-300 font-inter">
                      900 meters from Masterda Surya Sen Metro<br />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={handleCall}
                  className="flex-1 group relative px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-600 rounded-xl text-white font-semibold shadow-2xl shadow-amber-500/50 hover:shadow-amber-500/80 transition-all duration-300 hover:scale-105 overflow-hidden font-inter"
                >
                  <span className="relative z-10 flex items-center justify-center gap-2">
                    <Phone className="w-5 h-5" />
                    Call Now
                ...
                <button
                  onClick={handleVisit}
                  className="flex-1 px-8 py-4 bg-white/10 backdrop-blur-md border-2 border-white/30 rounded-xl text-white font-semibold hover:bg-white/20 hover:border-white/50 transition-all duration-300 hover:scale-105 shadow-xl flex items-center justify-center gap-2 font-inter"
                >
        ...
        <div className="container mx-auto">
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm font-inter">
              © 2024 Sun Ashraya. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
